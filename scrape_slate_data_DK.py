...
def scrape_slate_data(gameType):
    ...
    if gameType == 'PGA':
        ...
        API_url = 'https://www.draftkings.com/lobby/getcontests?sport={}'.format(gameType)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-s', '--sport', metavar='S', type=str, help='Determines the sport to extract data from.')
